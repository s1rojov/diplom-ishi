...
<template>
  <BaseModal
    ...
    customClass="w-1/2 bg-white p-5 relative backdrop-blur-[13px]"
  >
    <div
      class="absolute right-5 w-fit h-fit"
    ...
    <div class="flex flex-col gap-3">
      <div class="flex justify-center">
        <label for="file" class="cursor-pointer">
          <img
            :src="leadershipData.img"
            alt="img"
            v-if="leadershipData.img"
      ...
      <div>
        <label
          for="fio"
          class="block text-neutral-500 text-xs font-medium leading-[15px] tracking-wide pb-2"
          >F.I.O</label
        >
        <input
          type="text"
          class="bg-stone-50 w-full border border-zinc-100 outline-none py-2 px-1.5 rounded-lg"
          placeholder="Ism sharifi"
          id="fio"
          v-model="leadershipData.fullname"
          required
        />
      </div>
      <div>
        ...
        <input
          ...
          placeholder="Lavozim"
          id="position"
          v-model="leadershipData.position"
        />
      </div>
      <div class="grid grid-cols-3 grid-rows-1 gap-3">
        ...
        <div>
          ...
          <input
            type="text"
            class="bg-stone-50 w-full border border-zinc-100 outline-none py-2 px-1.5 rounded-lg"
            placeholder="Qabul kunlari"
            id="admission-day"
            required
            v-model="leadershipData.admission"
          />
        </div>
      </div>
    </div>
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="exp">
          <textarea
            ...
            id="exp"
            rows="5"
            v-model="leadershipData.experience"
            class="w-full outline-none border border-neutral-400/40 resize-none bg-stone-50 p-1"
          ></textarea>
        </q-tab-panel>
        <q-tab-panel name="obl">
          <textarea
            ...
            id="exp"
            rows="5"
            v-model="leadershipData.obligation"
            class="w-full outline-none border border-neutral-400/40 resize-none bg-stone-50 p-1"
          ></textarea>
        </q-tab-panel>
      </q-tab-panels>
